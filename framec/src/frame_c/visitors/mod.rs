...
pub trait AstVisitor {
    ...
    fn visit_call_expression_node(&mut self, method_call_expression_node:&CallExprNode) -> AstVisitorReturnType;
    fn visit_call_expression_node_to_string(&mut self, method_call_expression_node:&CallExprNode, output:&mut String) -> AstVisitorReturnType;
    fn visit_call_expr_list_node(&mut self, call_expr_list_node: &CallExprListNode) -> AstVisitorReturnType;
    fn visit_call_expr_list_node_to_string(&mut self, assignment_expr_list_node: &CallExprListNode, output:&mut String) -> AstVisitorReturnType;
    ...
    fn visit_transition_statement_node(&mut self, transition_node:&TransitionStatementNode) -> AstVisitorReturnType;
...
//    fn visit_argument_node(&mut self, argument:&Argument) -> AstVisitorReturnType;
    ...
    fn visit_test_statement_node(&mut self, test_statement_node:&TestStatementNode) -> AstVisitorReturnType;
    ...
    fn visit_string_match_test_pattern_node(&mut self, match_pattern_node:&StringMatchTestPatternNode) -> AstVisitorReturnType;
